...
<body>
	...
	require_once ('../Controller/DisplayPickInfo.php');
	$dms = showAllPick();
	?>
	...
	<div class="row">
		...
		<div class="col-6">
			<form method="post">
						...
						<tbody>
							<?php foreach ($dms as $i => $dms): ?>
								<tr>
									...
									<td align="middle"><?php echo $dms['address'] ?></td>
									<td align="middle"><?php echo $dms['phoneNumber'] ?></td>
									<td align="middle"><?php echo $dms['date'] ?></td>	
								</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
				...
				<p class="p-container">
					<input type="submit" name="submit" value="Picked">
			    </p>
			</form>
		</div>
	</div>
