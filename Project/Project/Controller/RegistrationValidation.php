...
$nameErr = $emailErr = $unameErr = $dobErr = $genderErr = $passwordErr = $cpasswordErr = "";
$name = $email = $uname = $dob = $gender = $password = $cpassword =  $error ="";
...
if (isset($_POST['submit'])) 
{
	...
	{  
        ...
        else
        {
        	...
        	$extra = array('name' => $name, 'e-mail' => $email, 'username' => $uname, 'password' => $password, 'gender' => $gender, 'dob' => $dob);
        	$array_data[] = $extra;  
